...
const CUISINE_OPTIONS = ['Japanese', 'Mexican', 'Middle Eastern', 'French', 'Italian', 'Spanish', 'Korean', 'Thai', 'Fusion', 'Other']
const COURSE_OPTIONS = ['Canapé', 'Otsumami', 'Crudo', 'Soup', 'Salad', 'Tartlet', 'Tempura', 'Croquette', 'Main', 'Dessert', 'Petit Four', 'Other']
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            {/* Course */}
            <div>
              <label htmlFor="course" className="block text-sm font-medium text-stone-700 mb-2">
                Course
              </label>
              <select
                id="course"
