...
const FILTER_OPTIONS = {
  ...
  course: ['All', 'Canapé', 'Otsumami', 'Crudo', 'Soup', 'Main', 'Dessert', 'Other'],
  cuisine: ['All', 'Japanese', 'Mexican', 'Middle Eastern', 'French', 'Italian', 'Fusion', 'Other'],
...
export default function RecipeLibrary() {
  ...
  const filteredRecipes = recipes.filter(recipe => {
    ...
    // Course filter
    if (filters.course !== 'All' && recipe.course !== filters.course) return false
